...
app.add_page(wordcloud_page, route=WORDCLOUD_ROUTE, on_load=AppState.check_login)
app.add_page(analysis_page, route=ANALYSIS_ROUTE, on_load=AppState.check_login)
